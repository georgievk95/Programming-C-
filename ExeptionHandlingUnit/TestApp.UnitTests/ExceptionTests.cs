...
public class ExceptionTests
{
    ...
    public void Test_AddNumbers_PositiveOverflow_ThrowsOverflowException()
    {
        ...
        int num2 = 1;
        // Act & Assert
        Assert.That(() => this._exceptions.OverflowAddNumbers(num1, num2),
    ...
    public void Test_DivideNumbers_DivideByZero_ThrowsDivideByZeroException()
    {
        ...
        int num2 = 0;
        // Act & Assert
        Assert.That(() => this._exceptions.DivideByZeroDivideNumbers(num1, num2),
    ...
    public void Test_SumCollectionElements_ValidCollectionAndIndex_ReturnsSum()
    {
        ...
        int index = 1;
        // Act
        int result = this._exceptions.SumCollectionElements(ints, index);
        // Assert
    ...
    public void Test_SumCollectionElements_NullCollection_ThrowsArgumentNullException()
    {
        ...
        int index = 1;
        // Act & Assert
        Assert.That(() => this._exceptions.SumCollectionElements(ints, index), 
    ...
    public void Test_GetElementAsNumber_KeyNotFound_ThrowsKeyNotFoundException()
    {
        ...
        string key = "ninth";
        // Act & Assert
        Assert.That(() => this._exceptions.GetElementAsNumber(collection, key),
            Throws.InstanceOf<KeyNotFoundException>());
    }
